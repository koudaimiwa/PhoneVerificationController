...
public struct Configuration {
    ...
    /**
     ...
     - Parameter background: The general background color. Default: white
     - Parameter text: The general foreground (text) color. Default: black
     - Parameter buttonTint: The tint color applied to all buttons and fields. Default: black
     ...
     - Parameter buttonBackgroundEnabled: The background color for enabled buttons. Default: orange
     - Parameter buttonBackgroundDisabled: The background color for disabled buttons. Default: lightGray
     - Parameter phonenumberFieldBorder: The border color for code fields. Default: lightGray
     - Parameter codeFieldBackgroundEmpty: The background color for empty code fields. Default: clear
     - Parameter codeFieldBackgroundFilled: The background color for filled code fields (and their border). Default: black
     - Parameter codeFieldBorder: The border color for code fields. Default: lightGray
    ...
    public init(statusBar: UIStatusBarStyle = .lightContent,
                keyboard: UIKeyboardAppearance = .default,
                background: UIColor = .white,
                text: UIColor = .black,
                buttonTint: UIColor = .darkGray,
                ...
                buttonBackgroundEnabled: UIColor = .orange,
                phonenumberFieldBorder: UIColor = .lightGray,
                codeFieldBackgroundEmpty: UIColor = .clear,
                codeFieldBackgroundFilled: UIColor = .white,
                codeFieldBorder: UIColor = .lightGray,
